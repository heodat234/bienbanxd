...
<body>
	<div class="menu">
	    <div class="container-fluid">
			...
			<div class="export col-md-2" >
				<ul class="nav navbar-nav navbar-right">
					<li><a href="<?php echo base_url(); ?>export/excelXayTuong"><span class="glyphicon glyphicon-user"></span> Xuất Excel</a></li>
					<li><a href="#"><span class="glyphicon glyphicon-log-in"></span> In</a></li>
				</ul>
			</div>
		</div>
	</div>
